...
import com.example.batch.domain.FilteringItemProcessor;
import com.example.batch.domain.UpperCaseItemProcessor;
...
public class JobConfiguration {
	...
	public FlatFileItemWriter<Customer> customerItemWriter() throws Exception {
		...
		String customerOutputPath = "./compositeItemProcessor/out/customers.out";
